(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		root["OpenHPS"] = root["OpenHPS"] || {}, root["OpenHPS"]["csv"] = factory(root["OpenHPS"]["core"]);
})((typeof self !== 'undefined' ? self : this), (__WEBPACK_EXTERNAL_MODULE__openhps_core__) => {
return /******/ (() => { // webpackBootstrap
/******/ 	var __webpack_modules__ = ({

/***/ "./dist/cjs/CSVDataObjectService.js":
/*!******************************************!*\
  !*** ./dist/cjs/CSVDataObjectService.js ***!
  \******************************************/
...
exports.CSVDataObjectService = void 0;
const tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
const core_1 = __webpack_require__(/*! @openhps/core */ "@openhps/core");
const csv = __webpack_require__(/*! csv-parser */ "./node_modules/csv-parser/index.js");
const fs = __webpack_require__(/*! fs */ "?a6da");
const stream_1 = __webpack_require__(/*! stream */ "?ecde");
class CSVDataObjectService extends core_1.DataObjectService {
    constructor(dataType, options) {
        super(new core_1.MemoryDataService(dataType));
    ...
    parseStream(s) {
        return new Promise((resolve, reject) => {
            ...
            const stream = s
                ...
                .on('data', (row) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                countUnprocessed++;
...
exports.CSVDataObjectService = CSVDataObjectService;
//# sourceMappingURL=CSVDataObjectService.js.map

/***/ }),

/***/ "./dist/cjs/CSVDataSource.js":
/*!***********************************!*\
  !*** ./dist/cjs/CSVDataSource.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
const core_1 = __webpack_require__(/*! @openhps/core */ "@openhps/core");
const path = __webpack_require__(/*! path */ "?7f83");
const fs = __webpack_require__(/*! fs */ "?a6da");
const csv = __webpack_require__(/*! csv-parser */ "./node_modules/csv-parser/index.js");
const stream_1 = __webpack_require__(/*! stream */ "?ecde");
/**
 ...
 */
class CSVDataSource extends core_1.ListSourceNode {
    constructor(file, rowCallback, options) {
        super([], options);
        this.options.source = this.options.source || new core_1.DataObject(file ? path.basename(file) : undefined);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
tslib_1.__exportStar(__webpack_require__(/*! ./CSVDataSource */ "./dist/cjs/CSVDataSource.js"), exports);
tslib_1.__exportStar(__webpack_require__(/*! ./CSVDataObjectService */ "./dist/cjs/CSVDataObjectService.js"), exports);
...
//# sourceMappingURL=openhps-csv.js.map